...
export interface ApiOutcomePathOutcomePath extends Struct.CollectionTypeSchema {
  collectionName: 'outcome_paths';
  info: {
    displayName: 'OutcomePath';
    pluralName: 'outcome-paths';
    singularName: 'outcome-path';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiOutcomeOutcome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    outcome_paths: Schema.Attribute.Relation<
      'oneToMany',
      'api::outcome-path.outcome-path'
    >;
